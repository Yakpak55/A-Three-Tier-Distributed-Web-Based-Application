...
<body>
    <div class="client">
        <h1>CNT 4714 Spring 2024 - Project 4 Enterprise System - Client</h1>
        <p>You are connected to the Project 4 Enterprise System Database as a <span class="highlight">client-level</span> user.</p>
